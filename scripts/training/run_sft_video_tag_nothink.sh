...
torchrun \
    ...
    --master_port=12951 \
    src/sft/sft_grounding_nothink.py \
    --deepspeed training_scripts/zero3_offload.json \
    --model_name_or_path ./huggingface/Qwen2.5-VL-3B-Instruct \
    --train_data_path ./temporal_grounding_gt/temporal_train_glue_re.csv \
    --eval_data_path ./temporal_grounding_gt/temporal_val_glue_re.csv \
